...
Route::prefix('registration')->group(function () {
    Route::post('send-otp', [RegistrationController::class, 'sendOtp'])->name('registration.sendOtp')->middleware('throttle:3,1');
    Route::post('verify-otp', [RegistrationController::class, 'verifyOtp'])->name('registration.verifyOtp')->middleware('throttle:3,1');
    Route::post('register', [RegistrationController::class, 'register'])->name('registration.register')->middleware('throttle:5,1');
...
// User Document Re-upload ... update
