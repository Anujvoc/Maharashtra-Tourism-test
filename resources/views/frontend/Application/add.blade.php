            ...
            <div class="form-step active" id="step1">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 " class="form-group">
                        ...
                        <input type="text"  class="form-control @error('applicantName') is-invalid @enderror" id="applicantName" name="applicantName" value="{{ old('applicantName') }}"
                        inputmode="text" text-uppercase
                    ...
                    <div class="col-md-6" class="form-group">
                        ...
                        <input type="tel" class="form-control" class="form-control" id="applicantPhone" name="applicantPhone" value="{{ old('applicantPhone') }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6" class="form-group">
                        ...
                        <input type="email" class="form-control" id="applicantEmail" name="applicantEmail" value="{{ old('applicantEmail') }}" required>
                    ...
                    <div class="col-md-6" class="form-group">
                        ...
                        <input type="text" text-uppercase class="form-control" id="businessName" name="businessName" value="{{ old('businessName') }}"
                        inputmode="text"
                        autocomplete="organization"
                        text-capitalize
                        oninput="
                ...
                <div class="row mb-3">
                    <div class="col-md-6" class="form-group">
                        ...
                        <select class="form-control" id="businessType" name="businessType" required>
                            ...
                            <option value="Pvt Ltd" {{ old('businessType') == 'Pvt Ltd' ? 'selected' : '' }}>Pvt Ltd</option>
                            <option value="LLP" {{ old('businessType') == 'LLP' ? 'selected' : '' }}>LLP</option>
                            <option value="Public Ltd" {{ old('businessType') == 'Public Ltd' ? 'selected' : '' }}>Public Ltd</option>
                            <option value="Co-operative" {{ old('businessType') == 'Co-operative' ? 'selected' : '' }}>Co-operative</option>
                            <option value="Society" {{ old('businessType') == 'Society' ? 'selected' : '' }}>Society</option>
                            <option value="Trust" {{ old('businessType') == 'Trust' ? 'selected' : '' }}>Trust</option>
                            <option value="SHG" {{ old('businessType') == 'SHG' ? 'selected' : '' }}>SHG</option>
                            <option value="JFMC" {{ old('businessType') == 'JFMC' ? 'selected' : '' }}>JFMC</option>
                            <option value="Other" {{ old('businessType') == 'Other' ? 'selected' : '' }}>Other</option>
                        </select>
                        @error('businessType')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6" class="form-group">
                        ...
                        <input type="text" text-uppercase  maxlength="10" class="form-control" id="panNumber" name="panNumber" value="{{ old('panNumber') }}"
    ...
    "
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="businessPanNumber" name="businessPanNumber" value="{{ old('businessPanNumber') }}"
                        pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}"
                        text-uppercase  maxlength="10"
                        title="Enter a valid 10-character PAN, e.g., ABCDE1234F"
                        oninput="
                          this.value = this.value.toUpperCase();
                          this.value = this.value.replace(/[^A-Z0-9]/g, '');
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="aadharNumber" name="aadharNumber" value="{{ old('aadharNumber') }}" required>
                        @error('aadharNumber')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="udyamAadharNumber" name="udyamAadharNumber" value="{{ old('udyamAadharNumber') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="ownershipProof" name="ownershipProof" required>
                            ...
                            <option value="7/12 document" {{ old('ownershipProof') == '7/12 document' ? 'selected' : '' }}>7/12 document</option>
                            <option value="Property Tax Receipts" {{ old('ownershipProof') == 'Property Tax Receipts' ? 'selected' : '' }}>Property Tax Receipts</option>
                            <option value="Property Card" {{ old('ownershipProof') == 'Property Card' ? 'selected' : '' }}>Property Card</option>
                            <option value="Other" {{ old('ownershipProof') == 'Other' ? 'selected' : '' }}>Other</option>
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="propertyRented" name="propertyRented" required>
                            ...
                            <option value="Yes" {{ old('propertyRented') == 'Yes' ? 'selected' : '' }}>Yes</option>
                            <option value="No" {{ old('propertyRented') == 'No' ? 'selected' : '' }}>No</option>
                        </select>
                    ...
                    <div class="col-md-6" id="operatorNameContainer" style="display: none;">
                        ...
                        <input type="text" class="form-control" id="operatorName" name="operatorName" value="{{ old('operatorName') }}">
                    </div>
                </div>
                ...
                <div class="form-navigation">
                    ...
                    <button type="button" class="btn btn-brand" id="nextToStep2"   style="
            ...
            <div class="form-step" id="step2">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="addressProof" name="addressProof" required>
                            <option value="" selected disabled>Select Proof Type</option>
                            <option value="Latest Electricity Bill" {{ old('addressProof') == 'Latest Electricity Bill' ? 'selected' : '' }}>Latest Electricity Bill</option>
                            <option value="Water Bill" {{ old('addressProof') == 'Water Bill' ? 'selected' : '' }}>Water Bill</option>
                            <option value="Other" {{ old('addressProof') == 'Other' ? 'selected' : '' }}>Other</option>
                        </select>
                        @error('addressProof')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="propertyCoordinates" name="propertyCoordinates" value="{{ old('propertyCoordinates') }}" required>
                        <div class="info-text text-danger">Example: 19.0760° N, 72.8777° E or Google Maps share link</div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="propertyOperational" name="propertyOperational" required>
                            <option value="" selected disabled>Select Yes/No</option>
                            <option value="Yes" {{ old('propertyOperational') == 'Yes' ? 'selected' : '' }}>Yes</option>
                            <option value="No" {{ old('propertyOperational') == 'No' ? 'selected' : '' }}>No</option>
                        </select>
                    ...
                    <div class="col-md-6" id="operationalDetailsContainer" style="display: none;">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" id="operationalYear" name="operationalYear" value="{{ old('operationalYear') }}" min="1900" max="2030">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" id="guestsHosted" name="guestsHosted" value="{{ old('guestsHosted') }}" min="0">
                                @error('guestsHosted')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="totalArea" name="totalArea" value="{{ old('totalArea') }}" min="0" required>
                        @error('totalArea')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="mahabookingNumber" name="mahabookingNumber" value="{{ old('mahabookingNumber') }}">
            ...
            <div class="form-step" id="step3">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="numberOfRooms" name="numberOfRooms" value="{{ old('numberOfRooms') }}" min="1" required>
                        @error('numberOfRooms')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="roomArea" name="roomArea" value="{{ old('roomArea') }}" min="0" required>
                        @error('roomArea')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-control" id="attachedToilet" name="attachedToilet" required>
                            <option value="" selected disabled>Select Yes/No</option>
                            <option value="Yes" {{ old('attachedToilet') == 'Yes' ? 'selected' : '' }}>Yes</option>
                            <option value="No" {{ old('attachedToilet') == 'No' ? 'selected' : '' }}>No</option>
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="foodProvided" name="foodProvided" required>
                            <option value="" selected disabled>Select Yes/No</option>
                            <option value="Yes" {{ old('foodProvided') == 'Yes' ? 'selected' : '' }}>Yes</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="paymentOptions" name="paymentOptions" required>
                            <option value="" selected disabled>Select Yes/No</option>
                            <option value="Yes" {{ old('paymentOptions') == 'Yes' ? 'selected' : '' }}>Yes</option>
                            <option value="No" {{ old('paymentOptions') == 'No' ? 'selected' : '' }}>No</option>
                        </select>
            ...
            <div class="form-step" id="step4">
                ...
                <div class="checkbox-grid mb-4">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="kitchen" name="facilities[]" value="kitchen" {{ in_array('kitchen', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="kitchen">
                            <i class="bi bi-egg-fried me-1"></i> Kitchen
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="diningHall" name="facilities[]" value="diningHall" {{ in_array('diningHall', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="diningHall">
                            <i class="bi bi-cup-straw me-1"></i> Dining Hall
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="garden" name="facilities[]" value="garden" {{ in_array('garden', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="garden">
                            <i class="bi bi-flower1 me-1"></i> Garden
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="parking" name="facilities[]" value="parking" {{ in_array('parking', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="parking">
                            <i class="bi bi-car-front me-1"></i> Parking
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="evCharging" name="facilities[]" value="evCharging" {{ in_array('evCharging', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="evCharging">
                            <i class="bi bi-lightning-charge me-1"></i> EV Charging
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="playArea" name="facilities[]" value="playArea" {{ in_array('playArea', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="playArea">
                            <i class="bi bi-joystick me-1"></i> Children Play Area
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="swimmingPool" name="facilities[]" value="swimmingPool" {{ in_array('swimmingPool', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="swimmingPool">
                            <i class="bi bi-water me-1"></i> Swimming Pool
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="wifi" name="facilities[]" value="wifi" {{ in_array('wifi', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="wifi">
                            <i class="bi bi-wifi me-1"></i> Wi-Fi
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="firstAid" name="facilities[]" value="firstAid" {{ in_array('firstAid', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="firstAid">
                            <i class="bi bi-bandaid me-1"></i> First Aid Box
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="fireSafety" name="facilities[]" value="fireSafety" {{ in_array('fireSafety', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="fireSafety">
                            <i class="bi bi-fire me-1"></i> Fire Safety Equipment
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="waterPurifier" name="facilities[]" value="waterPurifier" {{ in_array('waterPurifier', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="waterPurifier">
                            <i class="bi bi-droplet me-1"></i> Water Purifier / RO
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="rainwaterHarvesting" name="facilities[]" value="rainwaterHarvesting" {{ in_array('rainwaterHarvesting', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="rainwaterHarvesting">
                            <i class="bi bi-cloud-rain me-1"></i> Rainwater Harvesting
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="solarPower" name="facilities[]" value="solarPower" {{ in_array('solarPower', old('facilities', [])) ? 'checked' : '' }}>
                        <label class="form-check-label" for="solarPower">
                            <i class="bi bi-sun me-1"></i> Solar Power
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="renewableEnergy" name="facilities[]" value="renewableEnergy" {{ in_array('renewableEnergy', old('facilities', [])) ? 'checked' : '' }}>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="applicationFees" name="applicationFees" required>
                            <option value="" selected disabled>Select Yes/No</option>
                            <option value="Yes" {{ old('applicationFees') == 'Yes' ? 'selected' : '' }}>Yes</option>
                            <option value="No" {{ old('applicationFees') == 'No' ? 'selected' : '' }}>No</option>
                        </select>
                        @error('applicationFees')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        <div class="info-text text-info">Payment must be made through GRAS portal before submission</div>
                    </div>
                </div>
...
$(function () {
  ...
  const validator = $("#villaRegistrationForm").validate({
    ...
    rules: {
      // Step 1
      applicantName:   { required: true, lettersonly: true, minlength: 2, maxlength: 100 },
      applicantPhone:  { required: true, indMobile: true },
      applicantEmail:  { required: true, email: true, maxlength: 120 },
      businessName:    { required: true, lettersonly: true, minlength: 2, maxlength: 120 },
      businessType:    { required: true },
      panNumber:       { required: true, validPAN: true },
      businessPanNumber:{ validPAN: true }, // optional but must match if filled
      aadharNumber:    { required: true, validAadhar: true },
      udyamAadharNumber:{ alphanumeric: true, minlength: 6, maxlength: 25 }, // optional/loose
      ownershipProof:  { required: true },
      propertyRented:  { required: true },
      operatorName:    {
        required: {
          depends: function () { return $("#propertyRented").val() === "Yes"; }
        },
        lettersonly: true,
        minlength: {
          depends: function () { return $("#propertyRented").val() === "Yes"; },
    ...
    maxlength: 120
      ...
      // Step 2
      propertyName:        { required: true, minlength: 2, maxlength: 120 },
      propertyAddress:     { required: true, minlength: 5, maxlength: 500 },
      addressProof:        { required: true },
      propertyCoordinates: { required: true, coordsOrUrl: true },
      propertyOperational: { required: true },
      operationalYear: {
        required: {
          depends: function () { return $("#propertyOperational").val() === "Yes"; }
        },
        digits: true,
        yearRange: true
      },
      ...
      totalArea:       { required: true, number: true, min: 1, max: 10000000 },
      mahabookingNumber:{ alphanumeric: true, minlength: 4, maxlength: 40 }, // optional

      // Step 3
      numberOfRooms:   { required: true, digits: true, min: 1, max: 500 },
      roomArea:        { required: true, number: true, min: 1, max: 100000 },
      attachedToilet:  { required: true },
      dustbins:        { required: true },
      roadAccess:      { required: true },
      foodProvided:    { required: true },
      paymentOptions:  { required: true },

      // Step 4
      applicationFees: { required: true },
    ...
    messages: {
      ...
      businessType: { required: "Please select a type of business" },
      panNumber:    { required: "PAN number is required" },
      businessPanNumber: { validPAN: "Enter a valid Business PAN (or leave blank)" },
      aadharNumber: { required: "Aadhar number is required" },
      ownershipProof:{ required: "Please select ownership proof" },
      propertyRented:{ required: "Please select Yes/No" },
      operatorName:  { required: "Please enter operator name" },
      rentalAgreement:{
      ...
      propertyName:    { required: "Please enter property name" },
      propertyAddress: { required: "Please enter property address" },
      addressProof:    { required: "Please select address proof" },
      propertyCoordinates: {
        required: "Please enter coordinates or map link",
        coordsOrUrl: "Enter lat,long (e.g., 19.0760, 72.8777) or Google Maps URL"
      },
      propertyOperational:{ required: "Please select Yes/No" },
      operationalYear: {
      ...
      attachedToilet: { required: "Please select Yes/No" },
      dustbins:       { required: "Please select Yes/No" },
      roadAccess:     { required: "Please select Yes/No" },
      foodProvided:   { required: "Please select Yes/No" },
      paymentOptions: { required: "Please select Yes/No" },

      applicationFees: { required: "Please confirm if fees paid" },
