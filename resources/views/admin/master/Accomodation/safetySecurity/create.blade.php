...
@section('title', 'Add Safety and Security Forms')
...
<main class="main-wrapper">
    <div class="main-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Industrial Accomodation Safety and Security Forms</div>
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a></li>
              <li class="breadcrumb-item active" aria-current="page">Add Safety and security Forms</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
      ...
      <div class="col-12 col-xl-12">
        <div class="card border-top border-3 border-danger rounded-0">
                        <div class="card-body p-4">
                            <h5 class="mb-4">Add Safety and Security Forms</h5>
                            <form class="row g-3" method="POST" action="{{ route('admin.master.safetyAndSecurity.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        ...
                                        <a href="{{ route('admin.master.safetyAndSecurity.create') }}" class="btn btn-grd-royal px-4">Reset</a>
                                    </div>
                                </div>
                            </form>
