  ...
  <div class="container">
      <div class="d-md-flex justify-content-between text-start gap-4">
        ...
        <div>
          ...
          <ul class="list-unstyled small text-secondary d-flex flex-column gap-2">
            <li><i class="bi bi-geo-alt me-2 text-brand"></i> Mumbai, Maharashtra, India</li>
            <li><i class="bi bi-envelope me-2 text-brand"></i> info@maharashtratourism.example</li>
            <li><i class="bi bi-telephone me-2 text-brand"></i> +91 22 1234 5678</li>
          </ul>
        </div>
      </div>
