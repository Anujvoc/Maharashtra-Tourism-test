        ...
        <div class="col-auto align-items-end ">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a href="{{ route('admin.users.create') }}" class="btn btn-primary px-4">
              <i class="bi bi-plus-lg me-2"></i>Add Admin Users
            </a>
...
$(function () {
    let table = $('#applicationFormTable').DataTable({
        ...
        pageLength: 10,
        language: { searchPlaceholder: "Search by name or description...", search: "" },
        dom: '<"d-flex justify-content-between align-items-center mb-2"Bf>rt<"d-flex justify-content-between mt-3"lp>',
        buttons: [
            { extend: 'print', text: '<i class="bi bi-printer"></i> Print', className: 'btn btn-secondary btn-sm text-white' },
            { extend: 'excel', text: '<i class="bi bi-file-earmark-excel"></i> Excel', className: 'btn btn-success btn-sm text-white' },
            { extend: 'csv', text: '<i class="bi bi-file-earmark-text"></i> CSV', className: 'btn btn-primary btn-sm text-white' },
        ],
    });
