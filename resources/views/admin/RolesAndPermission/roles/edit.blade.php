                    ...
                    <form class="row g-3" method="POST" action="{{ route('admin.roles.update', $role->id) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative input-icon">
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                       id="input13" value="{{ old('name', $role->name) }}" required placeholder="Role Name">
                                <span class="position-absolute top-50 translate-middle-y"><i class="bi bi-person-badge"></i></span>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select name="is_visible"
                                    ...
                                    <option value="1" {{ old('is_visible', $role->status) == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('is_visible', $role->status) == '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="d-md-flex d-grid align-items-center gap-3">
                                ...
                                <a href="{{ route('admin.roles.edit', $role->id) }}" class="btn btn-grd-royal px-4">
