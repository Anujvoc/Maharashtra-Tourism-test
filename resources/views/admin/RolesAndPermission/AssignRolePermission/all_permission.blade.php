                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            @forelse ($role->permissions as $permission)
                                              <span class="badge rounded-pill bg-danger me-1 mb-1">{{ $permission->name }}</span>
                                            @empty
                                        ...
                                        <td class="d-flex gap-2">
                                            <a href="{{ route('admin.edit.roles.permission', $role->id) }}" class="btn btn-primary btn-sm rounded-circle">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>

                                            <a href="{{ route('admin.role.permission.delete', $role->id) }}" class="btn btn-danger btn-sm deletebutton rounded-circle" style="width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
