...
@section('title', 'Tourism Facility Forms')
      ...
      <div class="row g-3">
        ...
        <div class="col-auto align-items-end ">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a href="{{ route('admin.tourism-facilities.create') }}" class="btn btn-primary px-4">
              <i class="bi bi-plus-lg me-2"></i>Add Tourism Facility Forms
            </a>
...
<script>
    $(function () {
        let table = $('#applicationFormTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.tourism-facilities.data') }}',
            order: [[0, 'desc']],
            columns: [
