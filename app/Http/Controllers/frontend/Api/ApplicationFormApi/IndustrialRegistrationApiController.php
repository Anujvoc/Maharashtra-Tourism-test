...
class IndustrialRegistrationApiController extends Controller
{

public function getData($model, $message)
{
...
//            return response()->json([
//                 'status' => true,
//                 'message' => 'Safety And Security Data',
...
//            return response()->json([
//                 'status' => true,
//                 'message' => 'Additional Feature Data',
...
//            return response()->json([
//                 'status' => true,
//                 'message' => 'GeneralRequirement Data',
//                 'data' => $GeneralRequirement,
//             ]);
//      }
...
public function SafetyAndSecurity()
{
    return $this->getData(SafetyAndSecurity::class, 'Safety And Security Data');
}

public function AdditionalFeature()
{
    return $this->getData(AdditionalFeature::class, 'Additional Feature Data');
}

public function GeneralRequirement()
{
    return $this->getData(GeneralRequirement::class, 'General Requirement Data');
}

public function GuestService()
{
    return $this->getData(GuestService::class, 'Guest Service Data');
}
