        ...
        <div class="row g-3 align-items-center mb-2">
            ...
            <div class="col-auto ms-auto">
                <div class="d-flex align-items-center gap-2">
                    ...
                    {{-- Export (visible only if user can view) --}}
                    ...
                    @can('create ProvisionalArea')
                        <a href="{{ route('admin.master.area.create') }}"
                           class="btn btn-primary px-4">
                            <i class="bi bi-plus-lg me-2"></i>Add Area
                        </a>
                    @endcan
                </div>
            </div>
...
<script>
    $(function () {
        ...
        $('#applicationFormTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.master.area.data') }}',
            order: [[0, 'desc']],
            pageLength: 10,
        ...
        @else
            console.warn('You do not have permission to view Provisional Area data.');
        @endcan
