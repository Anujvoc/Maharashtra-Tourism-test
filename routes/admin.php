...
// });
Route::get('get_Region_District/{id}', [AdminUserController::class, 'get_Region_District'])->name('get_Region_District');
...
Route::middleware(['auth', 'is_role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/ApplicationForms/show/{model}/{id}', [ApplicationFormsController::class, 'show'])->name('ApplicationForms.model.show');
    Route::get('/ApplicationForms/report/{type}/{id}', [ApplicationFormsController::class, 'report'])->name('ApplicationForms.report');

    // Certificate Routes
    Route::get('/ApplicationForms/certificate/{type}/{id}/preview', [ApplicationFormsController::class, 'previewCertificate'])->name('certificate.show');
    Route::get('/ApplicationForms/certificate/{type}/{id}/download', [ApplicationFormsController::class, 'downloadCertificate'])->name('certificate.download');
    ...
    // Workflow Routes
    Route::post('/workflow/{type}/{id}/approve', [App\Http\Controllers\Admin\WorkflowController::class, 'approve'])->name('workflow.approve');
