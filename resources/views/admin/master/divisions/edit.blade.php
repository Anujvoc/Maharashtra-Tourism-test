        ...
        <div class="col-12 col-xl-12">
            <div class="card border-top border-3 border-danger rounded-0">
                <div class="card-body p-4">
                    ...
                    <form class="row g-3"
                          method="POST"
                          action="{{ route('admin.master.divisions.update', $division->id) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            @php
                                ...
                                $selectedDistricts = old('districts',
                                    is_string($division->districts)
                                        ? json_decode($division->districts, true)
                                        : ($division->districts ?? [])
                                );
                            @endphp
                                        ...
                                        <div class="col-md-2 col-4 mb-2">
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    {{ in_array($district->id, $selectedDistricts) ? 'checked' : '' }}
                                                >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative input-icon">
                                <select name="is_active"
                                        ...
                                        required>
                                    <option value="1" {{ old('is_active', $division->is_active) == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('is_active', $division->is_active) == '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="d-md-flex d-grid align-items-center gap-3">
                                ...
                                <a href="{{ route('admin.master.divisions.edit', $division->id) }}" class="btn btn-grd-royal px-4">Reset</a>
                            </div>
                        </div>
