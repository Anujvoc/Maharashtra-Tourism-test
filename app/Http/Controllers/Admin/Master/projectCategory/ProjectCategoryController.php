...
class ProjectCategoryController extends Controller implements HasMiddleware
{
      ...
      public function store(Request $request)
    {
        ...
        'name'        => 'required|string|max:191|unique:project_categories,name',
     ...
     public function data()
{
    ...
    return $badges;
        ...
        ->addColumn('actions', function ($row) {
            $edit = route('admin.projectCategory.edit', $row->id);
            $delete = route('admin.projectCategory.destroy', $row->id);
    ...
    $validated = $request->validate([
        'name' => 'required|string|max:191|unique:project_categories,name,' . $id,
        'is_active'   => 'required|boolean',
        'units'   => 'nullable|array',
        'units.*' => 'integer|exists:project_types,id',
