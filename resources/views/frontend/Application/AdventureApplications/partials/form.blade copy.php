...
<form id="adventureForm"
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    <label for="company_name" class="form-label required">
                        <i class="bi bi-buildings form-icon"></i> Name of Individual/Company/Partners
                    </label>
       ...
       value="{{ old('district_id', $application->district_id ?? '') }}">
        <div class="row">
                <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="district_id" class="form-label required">
                                        <i class="bi bi-geo form-icon"></i>Applicant Category
                                    </label>
                                    <select id="district_id" name="applicant" class="form-control district_id {{ $errors->has('district_id') ? 'is-invalid' : '' }}">
                                        <option value="" selected disabled>Select District</option>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="company_name" class="form-label ">
                            <i class="bi bi-buildings form-icon"></i>Business Start Date
                        </label>
                        <input  type="date" name="business_start_date"     id="business_start_date"
                            class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}"
                            value="{{ old('company_name', $application->company_name ?? '') }}">
                        @error('company_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
 ...
 <div class="col-md-8">
                    <div class="form-group mb-3">
                        <label for="company_name" class="form-label ">
                            <i class="bi bi-buildings form-icon"></i>Name and Designation of the person authorized by the organization/company
                        </label>
                        <input type="text" name="authorized_person"  pattern="^[A-Za-z\s]+$" id="authorized_person"
...
<div class="col-md-4">
                    <div class="form-group mb-3">
                        <label for="company_name" class="form-label ">
                            <i class="bi bi-buildings form-icon"></i>Applicant Website
                        </label>
                        <input id="applicant_website" type="text" name="applicant_website"  
                         name="applicant_website"
                        placeholder="Applicant Website"
                            class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}"
                            value="{{ old('company_name', $application->company_name ?? '') }}">
                        @error('company_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
...
<div class="col-md-6">
                <div class="form-group mb-3">
                    <label for="company_name" class="form-label ">
                        <i class="bi bi-buildings form-icon"></i>Applicant Social Media Handles
                    </label>
                    <input  type="text" name="social_media_handles"  pattern="^[A-Za-z\s]+$" id="authorized_person"
                   id="social_media_handles"
                   name="social_media_handles"
                   placeholder="Applicant Social Media Handles"
                    title="Only letters and spaces are allowed" required  onkeypress="return validateName(event)"
                           class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}"
                           value="{{ old('company_name', $application->company_name ?? '') }}">
                    @error('company_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
        ...
        <div class="form-group mb-3">
            <label for="applicant_address" class="form-label required1">
                <i class="bi bi-geo-alt form-icon"></i> Correspondence Address if Different from Applicant Address
            </label>
            <textarea id="applicant_address" name="applicant_address" rows="3"
                      class="form-control {{ $errors->has('applicant_address') ? 'is-invalid' : '' }}"
                      placeholder="Enter full address">{{ old('applicant_address', $application->applicant_address ?? '') }}</textarea>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="pan_file" class="form-label required">
                <i class="bi bi-file-earmark-text form-icon"></i> PAN1 Card (Max 5 MB)
            </label>
