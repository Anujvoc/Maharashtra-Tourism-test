        ...
        <div class="content-header bg-white-5">
            ...
            <a class="fw-semibold text-white tracking-wide" href="{{ route('admin.dashboard') }}">
                ...
                <span class="d-flex align-items-center">
                    <img src="{{ asset('backend/mah-logo-300x277.png') }}" alt="Logo" style="height:55px; width: 90px; background-color: #fff; padding: 3px;" class="me-4 text-primary rounded">
                    <!-- <span class="smini-hidden d-flex flex-column align-items-start">
                        <span style="font-size: 14px; line-height: 1;">PATNA</span>
                        <span class="opacity-75" style="font-size: 8px; line-height: 1;">National Institute of Electronics & Information Technology</span>
                    </span> -->
                </span>
            </a>
            <!-- END Logo -->
