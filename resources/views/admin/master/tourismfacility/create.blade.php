...
@section('title', 'Add Tourism Facility Forms')
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Add Tourism Facility Forms</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.tourism-facilities.create') }}" class="btn btn-danger px-4">
      ...
      <div class="col-12 col-xl-12">
        <div class="card border-top border-3 border-danger rounded-0">
                        <div class="card-body p-4">
                            <h5 class="mb-4">Add Tourism Facility Forms</h5>
                            <form class="row g-3" method="POST" action="{{ route('admin.tourism-facilities.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        ...
                                        <a href="{{ route('admin.tourism-facilities.create') }}" class="btn btn-grd-royal px-4">Reset</a>
                                    </div>
                                </div>
                            </form>
