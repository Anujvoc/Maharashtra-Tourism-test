...
<main class="main-wrapper">
  ...
  <div class="card border-top border-3 border-danger rounded-0">
    <div class="card-body p-4">
      <h5 class="mb-4">Add project category</h5>
      <form class="row g-3" method="POST" action="{{ route('admin.projectCategory.store') }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="col-md-2 col-4 mb-2">
                    <div class="form-check">
                        <input
                            ...
                            value="{{ $unit->id }}"
                            id="unit_{{ $unit->id }}"
                            @if(is_array(old('units')) && in_array($unit->id, old('unit'))) checked @endif
                        >
    ...
    @enderror
        ...
        <div class="col-md-12">
          <div class="d-md-flex d-grid align-items-center gap-3">
            ...
            <a href="{{ route('admin.projectCategory.create') }}" class="btn btn-grd-royal px-4">Reset</a>
          </div>
        </div>
      </form>
    </div>
