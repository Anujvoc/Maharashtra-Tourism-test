...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Zone Classification</div>
            <div class="ps-3">
        ...
        <div class="row g-3">
            ...
            <div class="col-auto align-items-end">
                <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                    ...
                    <a href="{{ route('admin.master.zone.create') }}" class="btn btn-primary px-4">
...
<script>
    $(function () {
        let table = $('#zoneTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.master.zone.data') }}',
            order: [[0, 'desc']],
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                { data: 'name', name: 'name' },
                { data: 'areas_badge', name: 'areas_badge' },
