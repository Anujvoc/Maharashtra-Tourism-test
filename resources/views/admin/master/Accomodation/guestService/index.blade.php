...
@section('title', 'Accomodation Guest Service Forms')
      ...
      <div class="row g-3">
        ...
        <div class="col-auto align-items-end ">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a href="{{ route('admin.master.guestService.create') }}" class="btn btn-primary px-4">
              <i class="bi bi-plus-lg me-2"></i>Add Guest Service
            </a>
				...
				<div class="card mt-2">
					...
					<div class="card-body">
						...
						<div class="table-responsive mt-2">
							<table id="guestServiceTable" class="table table-striped table-bordered">
								<thead>
...
<script>
    $(function () {
        let table = $('#guestServiceTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.master.guestService.data') }}',
            order: [[0, 'desc']],
            columns: [
