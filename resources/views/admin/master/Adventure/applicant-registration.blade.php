        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title m-0">
                    {{ isset($applicant) ? 'Edit Category' : 'Add Category For Applicant Registration' }}
                </h4>
            </div>

            <form action="{{ isset($applicant) 
                ? route('applicant-registration.update', $applicant->id) 
                : route('applicant-registration.store') }}" 
                method="post">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Edit -->
                                    <a href="{{ route('applicant-registration.edit', $item->id) }}"
                                    class="btn btn-sm btn-warning">
                                        Edit
                                    </a>

                                    <!-- Delete -->
                                    <form action="{{ route('applicant-registration.destroy', $item->id) }}"
                                        method="post"
