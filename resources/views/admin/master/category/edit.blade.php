...
<main class="main-wrapper">
    <div class="main-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.categories.index') }}" class="btn btn-danger px-4">
                ...
                <form class="row g-3" method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="position-relative input-icon">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                id="input13" value="{{ old('name', $category->name) }}" required placeholder="Name">
                    ...
                    <div class="col-md-12">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            ...
                            <a href="{{ route('admin.categories.edit', $category->id) }}" class="btn btn-grd-royal px-4">Reset</a>
                        </div>
                    </div>
                </form>
