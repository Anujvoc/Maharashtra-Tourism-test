...
!(function () {
    ...
    var e = {
            ...
            r: function (e) {
                void 0 !== xo &&
                    xo.toStringTag &&
                    Object.defineProperty(e, xo.toStringTag, {
                        value: "Module",
                    }),
    ...
    function Y(e) {
        for (var t = C(e), i = V(e); i && B(i) && "static" === z(i).position; )
            i = V(i);
        return i &&
            ("html" === S(i) || ("body" === S(i) && "static" === z(i).position))
            ? t
            : i ||
                  (function (e) {
    ...
    function te(e) {
        ...
        if (f) {
            var S = Y(i),
                ...
                j = "clientWidth";
            S === C(i) &&
                "static" !== z((S = R(i))).position &&
                "absolute" === u &&
                ((O = "scrollHeight"), (j = "scrollWidth")),
                (l === s || ((l === r || l === o) && c === d)) &&
                    ((A = n),
                    (y -=
                        (g && S === L && L.visualViewport
            ...
            : fe(
                  (function (e) {
                      ...
                      return (
                          "rtl" === z(n || i).direction &&
                              (a +=
                                  N(i.clientWidth, n ? n.clientWidth : 0) - o),
                ...
                if (S) {
                    if (d) {
                        var I,
                            ...
                            se = U(0, C[H], G[H]),
                            ne = k
                                ? C[H] / 2 - Q - se - te - T.mainAxis
                                : V - se - te - T.mainAxis,
                            oe = k
                                ? -C[H] / 2 + Q + se + ie + T.mainAxis
                                : K + se + ie + T.mainAxis,
    ...
    const Me = new Map(),
        Ne = {
            ...
            remove(e, t) {
                if (!Me.has(e)) return;
                const i = Me.get(e);
                i.delete(t), 0 === i.size && Me.delete(e);
            },
        },
        Pe = "transitionend",
        Fe = (e) => (
        ...
        Ue = (e, t = [], i = e) => ("function" == typeof e ? e(...t) : i),
        Ke = (e, t, i = !0) => {
            ...
            let n = !1;
            const o = ({ target: i }) => {
                i === t && ((n = !0), t.removeEventListener(Pe, o), Ue(e));
            };
    ...
    class bt {
        ...
        _mergeConfigObj(e, t) {
            const i = qe(t) ? _t.getDataAttribute(t, "config") : {};
            return {
                ...this.constructor.Default,
                ...("object" == typeof i ? i : {}),
                ...(qe(t) ? _t.getDataAttributes(t) : {}),
                ...("object" == typeof e ? e : {}),
            };
        }
    ...
    class vt extends bt {
        ...
        static getInstance(e) {
            return Ne.get(We(e), this.DATA_KEY);
        }
        ...
        Et = (e, t = "hide") => {
            ...
            pt.on(document, i, `[data-bs-dismiss="${s}"]`, function (i) {
                if (
                    ...
                    return;
                const n =
                    wt.getElementFromSelector(this) || this.closest(`.${s}`);
    ...
    class It extends bt {
        ...
        _initEvents() {
            this._supportPointerEvents
                ? (pt.on(this._element, Mt, (e) => this._start(e)),
    ...
    class li extends vt {
        ...
        _maybeEnableCycle() {
            this._config.ride &&
                (this._isSliding
                    ? pt.one(this._element, Yt, () => this.cycle())
                    : this.cycle());
        }
        to(e) {
            ...
            if (this._isSliding)
                return void pt.one(this._element, Yt, () => this.to(e));
        ...
        _addEventListeners() {
            this._config.keyboard &&
                pt.on(this._element, Xt, (e) => this._keydown(e)),
                "hover" === this._config.pause &&
                    (pt.on(this._element, Ut, () => this.pause()),
                    pt.on(this._element, Kt, () => this._maybeEnableCycle())),
                this._config.touch &&
                    It.isSupported() &&
        ...
        _setActiveIndicatorElement(e) {
            ...
            const t = wt.findOne(ii, this._indicatorsElement);
            t.classList.remove(ti), t.removeAttribute("aria-current");
            const i = wt.findOne(
                `[data-bs-slide-to="${e}"]`,
        ...
        _slide(e, t = null) {
            ...
            if (r(Vt).defaultPrevented) return;
            if (!i || !n) return;
        ...
        _getActive() {
            return wt.findOne(ni, this._element);
        }
        _getItems() {
            return wt.find(si, this._element);
        }
        _clearInterval() {
            this._interval &&
        ...
        _directionToOrder(e) {
            return Ye() ? (e === Rt ? Bt : zt) : e === Rt ? zt : Bt;
        }
        _orderToDirection(e) {
            return Ye() ? (e === Bt ? Rt : Qt) : e === Bt ? Qt : Rt;
        }
        static jQueryInterface(e) {
            return this.each(function () {
    ...
    pt.on(document, Jt, "[data-bs-slide], [data-bs-slide-to]", function (e) {
        const t = wt.getElementFromSelector(this);
        if (!t || !t.classList.contains(ei)) return;
        e.preventDefault();
        const i = li.getOrCreateInstance(t),
        ...
        pt.on(window, Gt, () => {
            ...
            for (const t of e) li.getOrCreateInstance(t);
        }),
        Xe(li);
    ...
    class Ei extends vt {
            ...
            if (
                (this._config.parent &&
                    (e = this._getFirstLevelChildren(
                        ...
                        .map((e) => Ei.getOrCreateInstance(e, { toggle: !1 }))),
        ...
        hide() {
            if (this._isTransitioning || !this._isShown()) return;
            if (pt.trigger(this._element, ui).defaultPrevented) return;
        ...
        _getFirstLevelChildren(e) {
            const t = wt.find(bi, this._config.parent);
            return wt
        ...
        static jQueryInterface(e) {
            ...
            return (
                ...
                this.each(function () {
                    const i = Ei.getOrCreateInstance(this, t);
                    if ("string" == typeof e) {
                        if (void 0 === i[e])
                            throw new TypeError(`No method named "${e}"`);
                        i[e]();
    ...
    pt.on(document, fi, vi, function (e) {
        ("A" === e.target.tagName ||
            (e.delegateTarget && "A" === e.delegateTarget.tagName)) &&
            e.preventDefault();
        for (const e of wt.getMultipleElementsFromSelector(this))
            Ei.getOrCreateInstance(e, { toggle: !1 }).toggle();
    }),
        Xe(Ei);
    const xi = "dropdown",
        ki = ".bs.dropdown",
        ...
        Ii = `${Fi}.${Pi}`,
        qi = ".dropdown-menu",
        Wi = Ye() ? "top-end" : "top-start",
        $i = Ye() ? "top-start" : "top-end",
        Hi = Ye() ? "bottom-end" : "bottom-start",
        zi = Ye() ? "bottom-start" : "bottom-end",
        Bi = Ye() ? "left-start" : "right-start",
        Ri = Ye() ? "right-start" : "left-start",
        Qi = {
            autoClose: !0,
    ...
    class Yi extends vt {
        constructor(e, t) {
            super(e, t),
                ...
                (this._menu =
                    wt.next(this._element, qi)[0] ||
                    wt.prev(this._element, qi)[0] ||
                    wt.findOne(qi, this._parent)),
        ...
        show() {
            ...
            if (!pt.trigger(this._element, ji, e).defaultPrevented) {
                if (
                    (this._createPopper(),
                    "ontouchstart" in document.documentElement &&
        ...
        _getPlacement() {
            ...
            if (e.classList.contains("dropstart")) return Ri;
            ...
            const t =
                ...
                getComputedStyle(this._menu)
                    ...
                    .trim();
            return e.classList.contains("dropup") ? (t ? $i : Wi) : t ? zi : Hi;
        }
        _detectNavbar() {
        ...
        _getPopperConfig() {
            ...
            return (
                ...
                { ...e, ...Ue(this._config.popperConfig, [e]) }
            );
        }
        _selectMenuItem({ key: e, target: t }) {
            const i = wt
                ...
                .filter((e) => $e(e));
            i.length && Ze(i, t, e === Si, !i.includes(t)).focus();
        }
        static jQueryInterface(e) {
            return this.each(function () {
        ...
        static dataApiKeydownHandler(e) {
            const t = /input|textarea/i.test(e.target.tagName),
                i = "Escape" === e.key,
                s = [Li, Si].includes(e.key);
            if (!s && !i) return;
            if (t && !i) return;
            e.preventDefault();
            const n = this.matches(Fi)
                    ? this
                    : wt.prev(this, Fi)[0] ||
                      wt.next(this, Fi)[0] ||
                      wt.findOne(Fi, e.delegateTarget.parentNode),
                o = Yi.getOrCreateInstance(n);
            if (s)
                return e.stopPropagation(), o.show(), void o._selectMenuItem(e);
            o._isShown() && (e.stopPropagation(), o.hide(), n.focus());
        }
    }
    pt.on(document, Mi, Fi, Yi.dataApiKeydownHandler),
        pt.on(document, Mi, qi, Yi.dataApiKeydownHandler),
        pt.on(document, Di, Yi.clearMenus),
        pt.on(document, Ni, Yi.clearMenus),
        pt.on(document, Di, Fi, function (e) {
    ...
    const es = ".bs.focustrap",
        ts = `focusin${es}`,
        is = `keydown.tab${es}`,
        ss = "backward",
        ns = { autofocus: !0, trapElement: null },
        os = { autofocus: "boolean", trapElement: "element" };
    class rs extends bt {
        constructor(e) {
            super(),
                (this._config = this._getConfig(e)),
        ...
        activate() {
            this._isActive ||
                ...
                pt.off(document, es),
                pt.on(document, ts, (e) => this._handleFocusin(e)),
                pt.on(document, is, (e) => this._handleKeydown(e)),
                (this._isActive = !0));
        }
        deactivate() {
            this._isActive && ((this._isActive = !1), pt.off(document, es));
        }
        _handleFocusin(e) {
        ...
        _handleKeydown(e) {
            "Tab" === e.key &&
                (this._lastTabNavDirection = e.shiftKey ? ss : "forward");
        }
    }
    ...
    const us = ".bs.modal",
        ...
        bs = `resize${us}`,
        vs = `click.dismiss${us}`,
        ys = `mousedown.dismiss${us}`,
        ws = `keydown.dismiss${us}`,
        Es = `click${us}.data-api`,
        xs = "modal-open",
        ks = "show",
        As = "modal-static",
        Ls = { backdrop: !0, focus: !0, keyboard: !0 },
        Ss = {
    ...
    class Cs extends vt {
        ...
        show(e) {
            this._isShown ||
                ...
                pt.trigger(this._element, gs, { relatedTarget: e })
                    .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
        ...
        _initializeFocusTrap() {
            return new rs({ trapElement: this._element });
        }
        _showElement(e) {
                ...
                this._queueCallback(
                    () => {
                        this._config.focus && this._focustrap.activate(),
                            (this._isTransitioning = !1),
                            pt.trigger(this._element, _s, { relatedTarget: e });
                    },
                    this._dialog,
                    this._isAnimated()
                );
        ...
        _triggerBackdropTransition() {
            if (pt.trigger(this._element, fs).defaultPrevented) return;
            const e =
                    this._element.scrollHeight >
                    document.documentElement.clientHeight,
                t = this._element.style.overflowY;
            "hidden" === t ||
                this._element.classList.contains(As) ||
        ...
        static jQueryInterface(e, t) {
            return this.each(function () {
                const i = Cs.getOrCreateInstance(this, e);
                if ("string" == typeof e) {
                    if (void 0 === i[e])
                        throw new TypeError(`No method named "${e}"`);
                    i[e](t);
    ...
    pt.on(document, Es, '[data-bs-toggle="modal"]', function (e) {
        const t = wt.getElementFromSelector(this);
        ...
        i && Cs.getInstance(i).hide(), Cs.getOrCreateInstance(t).toggle(this);
    }),
        Et(Cs),
        Xe(Cs);
    const Os = ".bs.offcanvas",
        js = ".data-api",
        Ts = `load${Os}${js}`,
        Ds = "show",
        Ms = "showing",
    ...
    class Vs extends vt {
        ...
        show(e) {
            this._isShown ||
                ...
                ((this._isShown = !0),
                this._backdrop.show(),
                this._config.scroll || new hs().hide(),
                this._element.setAttribute("aria-modal", !0),
                this._element.setAttribute("role", "dialog"),
                ...
                this._queueCallback(
                    () => {
                        (this._config.scroll && !this._config.backdrop) ||
                            ...
                            pt.trigger(this._element, Is, { relatedTarget: e });
                    },
                    this._element,
                    !0
                ));
        ...
        hide() {
            this._isShown &&
                (pt.trigger(this._element, qs).defaultPrevented ||
                    (this._focustrap.deactivate(),
                    this._element.blur(),
                    (this._isShown = !1),
                    ...
                    this._queueCallback(
                        () => {
                            this._element.classList.remove(Ds, Ns),
                                this._element.removeAttribute("aria-modal"),
                                this._element.removeAttribute("role"),
                                this._config.scroll || new hs().reset(),
                                pt.trigger(this._element, $s);
                        },
                        this._element,
                        !0
                    )));
    ...
    pt.on(document, zs, '[data-bs-toggle="offcanvas"]', function (e) {
        ...
        i && i !== t && Vs.getInstance(i).hide(),
            Vs.getOrCreateInstance(t).toggle(this);
    }),
        pt.on(window, Ts, () => {
            for (const e of wt.find(Ps)) Vs.getOrCreateInstance(e).show();
        }),
        pt.on(window, Hs, () => {
    ...
    const Ys = {
        ...
        Us = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,
        Ks = (e, t) => {
            const i = e.nodeName.toLowerCase();
            return t.includes(i)
                ? !Xs.has(i) || Boolean(Us.test(e.nodeValue))
    ...
    class en extends bt {
        ...
        _checkContent(e) {
            for (const [t, i] of Object.entries(e))
                super._typeCheckConfig({ selector: t, entry: i }, Js);
        }
        _setContent(e, t, i) {
            ...
            s &&
                ((t = this._resolvePossibleFunction(t))
                    ? qe(t)
                        ? this._putElementInTemplate(We(t), s)
                        : this._config.html
                ...
                ? (function (e, t, i) {
                      ...
                      for (const e of n) {
                          ...
                          const s = [].concat(...e.attributes),
                              n = [].concat(t["*"] || [], t[i] || []);
                          for (const t of s)
                              Ks(t, n) || e.removeAttribute(t.nodeName);
                      }
    ...
    class pn extends vt {
        ...
        dispose() {
            clearTimeout(this._timeout),
                pt.off(this._element.closest(rn), an, this._hideModalHandler),
        ...
        _createPopper(e) {
            const t = Ue(this._config.placement, [this, e, this._element]),
                i = dn[t.toUpperCase()];
        ...
        _getPopperConfig(e) {
            ...
            return { ...t, ...Ue(this._config.popperConfig, [t]) };
        }
        _setListeners() {
            ...
            for (const t of e)
                if ("click" === t)
                    ...
                    pt.on(this._element, e, this._config.selector, (e) => {
                        ...
                        (t._activeTrigger["focusin" === e.type ? cn : ln] = !0),
                            t._enter();
                    }),
                        pt.on(this._element, i, this._config.selector, (e) => {
                            const t = this._initializeOnDelegatedTarget(e);
                            (t._activeTrigger["focusout" === e.type ? cn : ln] =
            ...
            (this._hideModalHandler = () => {
                ...
                pt.on(this._element.closest(rn), an, this._hideModalHandler);
        }
        _fixTitle() {
    ...
    const fn = ".popover-header",
        ...
        _n = { ...pn.DefaultType, content: "(null|string|element|function)" };
    class bn extends pn {
        static get Default() {
            return gn;
        }
        ...
        _getContentForTemplate() {
            return { [fn]: this._getTitle(), [mn]: this._getContent() };
        }
        _getContent() {
    ...
    const vn = ".bs.scrollspy",
        ...
        kn = "[href]",
        An = ".nav-link",
        Ln = `${An}, .nav-item > ${An}, .list-group-item`,
        Sn = {
            offset: null,
    ...
    class On extends vt {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll &&
                (pt.off(this._config.target, wn),
                pt.on(this._config.target, wn, kn, (e) => {
        ...
        _initializeTargetsAndObservables() {
            (this._targetLinks = new Map()),
                (this._observableSections = new Map());
            const e = wt.find(kn, this._config.target);
            for (const t of e) {
        ...
        _process(e) {
            this._activeTarget !== e &&
                ...
                pt.trigger(this._element, yn, { relatedTarget: e }));
        }
        _activateParents(e) {
            if (e.classList.contains("dropdown-item"))
                ...
                for (const t of wt.parents(e, ".nav, .list-group"))
                    for (const e of wt.prev(t, Ln)) e.classList.add(xn);
        }
        _clearActiveClass(e) {
            e.classList.remove(xn);
            const t = wt.find(`${kn}.${xn}`, e);
            for (const e of t) e.classList.remove(xn);
        }
        static jQueryInterface(e) {
            return this.each(function () {
    ...
    const jn = ".bs.tab",
        ...
        Kn = `.nav-link${Xn}, .list-group-item${Xn}, [role="tab"]${Xn}, ${Un}`,
        Zn = `.${Rn}[data-bs-toggle="tab"], .${Rn}[data-bs-toggle="pill"], .${Rn}[data-bs-toggle="list"]`;
    class Gn extends vt {
        constructor(e) {
            super(e),
                ...
                this._parent &&
                    ...
                    pt.on(this._element, Fn, (e) => this._keydown(e)));
        }
        static get NAME() {
            return "tab";
        }
        show() {
            ...
            const t = this._getActiveElem(),
                i = t ? pt.trigger(t, Tn, { relatedTarget: e }) : null;
            pt.trigger(e, Mn, { relatedTarget: t }).defaultPrevented ||
                    ...
                    () => {
                        "tab" === e.getAttribute("role")
                            ? (e.removeAttribute("tabindex"),
                              ...
                              pt.trigger(e, Nn, { relatedTarget: t }))
                            : e.classList.add(Vn);
                    },
                    e,
                    e.classList.contains(Qn)
                ));
        }
        _deactivate(e, t) {
            e &&
                    ...
                    () => {
                        "tab" === e.getAttribute("role")
                            ? (e.setAttribute("aria-selected", !1),
                              ...
                              pt.trigger(e, Dn, { relatedTarget: t }))
        ...
        _keydown(e) {
            if (![qn, Wn, $n, Hn, zn, Bn].includes(e.key)) return;
            e.stopPropagation(), e.preventDefault();
            const t = this._getChildren().filter((e) => !He(e));
            let i;
            if ([zn, Bn].includes(e.key))
                i = t[e.key === zn ? 0 : t.length - 1];
            else {
                const s = [Wn, Hn].includes(e.key);
                i = Ze(t, e.target, s, !0);
            }
            i &&
                (i.focus({ preventScroll: !0 }),
                Gn.getOrCreateInstance(i).show());
        }
        _getChildren() {
            return wt.find(Kn, this._parent);
        }
        _getActiveElem() {
            return (
        ...
        _getInnerElement(e) {
            return e.matches(Kn) ? e : wt.findOne(Kn, e);
        }
        _getOuterElement(e) {
        ...
        static jQueryInterface(e) {
            return this.each(function () {
                const t = Gn.getOrCreateInstance(this);
                if ("string" == typeof e) {
                    if (
                        void 0 === t[e] ||
                        e.startsWith("_") ||
    ...
    pt.on(document, Pn, Un, function (e) {
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
            He(this) || Gn.getOrCreateInstance(this).show();
    }),
        pt.on(window, In, () => {
            for (const e of wt.find(Zn)) Gn.getOrCreateInstance(e);
        }),
        Xe(Gn);
    const Jn = ".bs.toast",
        eo = `mouseover${Jn}`,
    ...
    class fo extends vt {
        ...
        show() {
            pt.trigger(this._element, ro).defaultPrevented ||
                (this._clearTimeout(),
        ...
        hide() {
            this.isShown() &&
                (pt.trigger(this._element, no).defaultPrevented ||
        ...
        _setListeners() {
            pt.on(this._element, eo, (e) => this._onInteraction(e, !0)),
                ...
                pt.on(this._element, io, (e) => this._onInteraction(e, !0)),
                pt.on(this._element, so, (e) => this._onInteraction(e, !1));
        }
        _clearTimeout() {
    ...
    var mo = function (e) {
        ...
        go =
            ...
            global,
        _o = "object" == typeof self && self && self.Object === Object && self,
        bo = go || _o || Function("return this")(),
        vo = function () {
            return bo.Date.now();
        },
        yo = /\s/,
        ...
        So = Ao.toString,
        Co = ko ? ko.toStringTag : void 0,
        Oo = Object.prototype.toString,
        jo = ko ? ko.toStringTag : void 0,
        To = function (e) {
            return null == e
                ? void 0 === e
                    ? "[object Undefined]"
                ...
                ? (function (e) {
                      ...
                      var n = So.call(e);
                      return s && (t ? (e[Co] = i) : delete e[Co]), n;
                  })(e)
                : (function (e) {
                      return Oo.call(e);
                  })(e);
        ...
        Wo = function (e, t, i) {
            ...
            return (
                ...
                mo(i) &&
                    ((d = !!i.leading),
                    (o = (h = "maxWait" in i) ? Io(Fo(i.maxWait) || 0, t) : o),
    ...
    var Yo = !(
        ...
        Xo = Object.freeze({
            ...
            addClasses: Ro,
            canUseDOM: Yo,
            classNamesToQuery: Vo,
            getElementDocument: zo,
            getElementWindow: Ho,
            getOptions: Bo,
            removeClasses: Qo,
        }),
    ...
    function Zo() {
        if (null === Uo) {
            if ("undefined" == typeof document) return (Uo = 0);
            var e = document.body,
                t = document.createElement("div");
            t.classList.add("simplebar-hide-scrollbar"), e.appendChild(t);
            var i = t.getBoundingClientRect().right;
            e.removeChild(t), (Uo = i);
        }
        return Uo;
    }
    Yo &&
        window.addEventListener("resize", function () {
            Ko !== window.devicePixelRatio &&
                ((Ko = window.devicePixelRatio), (Uo = null));
        });
    var Go = Ho,
        Jo = zo,
        er = Bo,
            ...
            function e(t, i) {
                ...
                if (
                    ...
                    (this.onScroll = function () {
                        ...
                        s.scrollXTicking ||
                            ...
                            s.isScrolling ||
                                ((s.isScrolling = !0),
                                tr(s.el, s.classNames.scrolling)),
                            s.showScrollbar("x"),
                            s.showScrollbar("y"),
                            s.onStopScrolling();
                    }),
                    ...
                    (this._onStopScrolling = function () {
                        ir(s.el, s.classNames.scrolling),
                            s.options.autoHide &&
                    ...
                    (this.onMouseEnter = function () {
                        s.isMouseEntering ||
                            (tr(s.el, s.classNames.mouseEntered),
                            s.showScrollbar("x"),
                            s.showScrollbar("y"),
                            (s.isMouseEntering = !0)),
                            s.onMouseEntered();
                    ...
                    (this._onMouseEntered = function () {
                        ir(s.el, s.classNames.mouseEntered),
                            s.options.autoHide &&
                                (s.hideScrollbar("x"), s.hideScrollbar("y")),
                            (s.isMouseEntering = !1);
                    }),
                    ...
                    (this.el = t),
                    (this.options = $o($o({}, e.defaultOptions), i)),
                    (this.classNames = $o(
                        $o({}, e.defaultOptions.classNames),
                        i.classNames
                    )),
                    (this.axis = {
                        x: {
                ...
                (this.onMouseMove = (function (e, t, i) {
                    ...
                    return (
                        ...
                        Wo(e, t, { leading: s, maxWait: t, trailing: n })
                    );
                })(this._onMouseMove, 64)),
                    (this.onWindowResize = Wo(this._onWindowResize, 64, {
                        leading: !0,
                    })),
                    (this.onStopScrolling = Wo(
                        this._onStopScrolling,
                        this.stopScrollDelay
                    )),
                    (this.onMouseEntered = Wo(
            ...
            return (
                ...
                (e.prototype.initDOM = function () {
                    ...
                    (this.wrapperEl = this.el.querySelector(
                        sr(this.classNames.wrapper)
                    )),
                        (this.contentWrapperEl =
                            this.options.scrollableNode ||
                            this.el.querySelector(
                                sr(this.classNames.contentWrapper)
                            )),
                        (this.contentEl =
                            this.options.contentNode ||
                            this.el.querySelector(
                                sr(this.classNames.contentEl)
                            )),
                        (this.offsetEl = this.el.querySelector(
                            sr(this.classNames.offset)
                        )),
                        (this.maskEl = this.el.querySelector(
                            sr(this.classNames.mask)
                        )),
                        (this.placeholderEl = this.findChild(
                            this.wrapperEl,
                            sr(this.classNames.placeholder)
                        )),
                        (this.heightAutoObserverWrapperEl =
                            this.el.querySelector(
                                sr(this.classNames.heightAutoObserverWrapperEl)
                            )),
                        (this.heightAutoObserverEl = this.el.querySelector(
                            sr(this.classNames.heightAutoObserverEl)
                        )),
                        (this.axis.x.track.el = this.findChild(
                            this.el,
                            ""
                                .concat(sr(this.classNames.track))
                                .concat(sr(this.classNames.horizontal))
                        )),
                        (this.axis.y.track.el = this.findChild(
                            this.el,
                            ""
                                .concat(sr(this.classNames.track))
                                .concat(sr(this.classNames.vertical))
                        )),
                        (this.axis.x.scrollbar.el =
                            (null === (e = this.axis.x.track.el) || void 0 === e
                                ? void 0
                                : e.querySelector(
                                      sr(this.classNames.scrollbar)
                                  )) || null),
                ...
                (e.prototype.recalculate = function () {
                    if (
                        ...
                        var d = this.axis.x.isOverflowing
                                ? this.scrollbarWidth
                                : 0,
                            h = this.axis.y.isOverflowing
                                ? this.scrollbarWidth
                                : 0;
                        (this.axis.x.isOverflowing =
                    ...
                    t.track.el &&
                        ...
                        this.isWithinBounds(t.track.rect)
                            ? (this.showScrollbar(e),
                              tr(t.track.el, this.classNames.hover),
                              this.isWithinBounds(t.scrollbar.rect)
                                  ? tr(t.scrollbar.el, this.classNames.hover)
                                  : ir(t.scrollbar.el, this.classNames.hover))
                            : (ir(t.track.el, this.classNames.hover),
                              this.options.autoHide && this.hideScrollbar(e)));
                }),
                (e.prototype.onMouseLeaveForAxis = function (e) {
                    void 0 === e && (e = "y"),
                        ir(this.axis[e].track.el, this.classNames.hover),
                        ir(this.axis[e].scrollbar.el, this.classNames.hover),
                        this.options.autoHide && this.hideScrollbar(e);
                }),
                (e.prototype.onDragStart = function (e, t) {
                    ...
                    (this.axis[t].dragOffset =
                        ...
                        (this.draggedAxis = t),
                        tr(this.el, this.classNames.dragging),
                    ...
                    if (
                        ...
                        var c =
                            ...
                            d = parseInt(
                                null !==
                                    (o =
                                        null === (n = this.elStyles) ||
                                        void 0 === n
                                            ? void 0
                                            : n[this.axis[t].sizeAttr]) &&
                                    void 0 !== o
                                    ? o
                                    : "0px",
                                10
            ...
            return (
                ...
                (t.prototype.initDOM = function () {
                    ...
                    if (
                        ...
                        for (
                            this.wrapperEl = document.createElement("div"),
                                ...
                                this.heightAutoObserverEl =
                                    document.createElement("div"),
                                lr(this.wrapperEl, this.classNames.wrapper),
                                lr(
                                    this.contentWrapperEl,
                                    this.classNames.contentWrapper
                                ),
                                lr(this.offsetEl, this.classNames.offset),
                                lr(this.maskEl, this.classNames.mask),
                                lr(this.contentEl, this.classNames.contentEl),
                                lr(
                                    this.placeholderEl,
                    ...
                    if (!this.axis.x.track.el || !this.axis.y.track.el) {
                        ...
                        lr(n, this.classNames.track),
                            lr(o, this.classNames.scrollbar),
                            n.appendChild(o),
                            ...
                            lr(this.axis.y.track.el, this.classNames.vertical),
                            this.el.appendChild(this.axis.x.track.el),
                            this.el.appendChild(this.axis.y.track.el);
                    }
                    nr.prototype.initDOM.call(this),
                        this.el.setAttribute("data-simplebar", "init");
                }),
                (t.prototype.unMount = function () {
                    nr.prototype.unMount.call(this),
            ...
            let t =
                ...
                i = {
                    ...
                    "dm-table-tools-sections": () =>
                        this.dmTableToolsSections(),
                    "dm-table-tools-checkable": () =>
                        this.dmTableToolsCheckable(),
                            ...
                            (r = e.querySelector("." + o)),
                                ...
                                (s =
                                    ...
                                    (e.getBoundingClientRect().left +
                                        window.scrollX) -
                                    parseFloat(
                                        getComputedStyle(r).width.replace(
                                            "px",
                                            ""
                                        )
                                    ) /
                                ...
                                (n =
                                    ...
                                    (e.getBoundingClientRect().top +
                                        window.scrollY) -
                                    parseFloat(
                                        getComputedStyle(r).height.replace(
                                            "px",
                                            ""
                                        )
                                    ) /
        ...
        static jqSlick() {
            jQuery(".js-slider:not(.js-slider-enabled)").each((e, t) => {
                ...
                i.addClass("js-slider-enabled").slick({
                    ...
                    infinite:
                        void 0 === i.data("infinite") || i.data("infinite"),
                });
            });
        }
        static jqDatepicker() {
            ...
            jQuery(".js-pw-strength:not(.js-pw-strength-enabled)").each(
                (e, t) => {
                    ...
                    i.addClass("js-pw-strength-enabled").pwstrength({
                        ui: {
                            container: s,
                            viewports: { progress: n, verdict: o },
                        },
                    });
                }
            );
                    ...
                    r = {
                        line: () => {
                            (o.type = n),
                                ...
                                (o.lineColor =
                                    s.data("line-color") || "#0665d0"),
                                (o.fillColor =
                                    s.data("fill-color") || "#0665d0"),
                                (o.spotColor =
                                    s.data("spot-color") || "#495057"),
                                (o.minSpotColor =
                                    s.data("min-spot-color") || "#495057"),
                                (o.maxSpotColor =
                                    s.data("max-spot-color") || "#495057"),
                                (o.highlightSpotColor =
                                    s.data("highlight-spot-color") ||
                                    "#495057"),
                        ...
                        tristate: () => {
                            (o.type = n),
                                ...
                                (o.barSpacing = s.data("bar-spacing") || 6),
                                (o.posBarColor =
                                    s.data("pos-bar-color") || "#82b54b"),
                                (o.negBarColor =
                                    s.data("neg-bar-color") || "#e04f1a");
                        },
                    };
                r[n]
                    ? (r[n](),
    ...
    (window.bootstrap = i), (window.SimpleBar = dr);
    class fr {
        constructor(e) {
            this.onLoad(() => this._uiInit(e));
        }
        _uiInit(e) {
            (this._lHtml = document.documentElement),
                ...
                (this._darkMode =
                    (null == e ? void 0 : e.darkMode) || "system"),
            ...
            (t._lSidebar || t._lSideOverlay) &&
                ("init" === e
                    ...
                    : (e = "custom-scroll") &&
                      ...
                      (t._lSidebar &&
                          !t._lSidebarScroll &&
                          (t._lSidebarScroll = new dr(t._lSidebarScrollCon)),
                      t._lSideOverlay &&
                          !t._lSideOverlayScroll &&
                          (t._lSideOverlayScroll = new dr(t._lSideOverlay))));
        }
        _uiHandleHeader() {
            let e = this;
                    ...
                    e.addEventListener("click", (t) => {
                        ...
                        if (
                            ...
                            t.classList.contains("open")
                                ...
                                : (Array.from(e.closest("ul").children).forEach(
                                      (e) => {
        ...
        _uiHandleDarkMode(e) {
            let t = this,
                i = !t._lHtml.classList.contains("dark-custom-defined"),
                s = document.querySelector('[data-dark-mode="off"]'),
                n = document.querySelector('[data-dark-mode="on"]'),
                o = document.querySelector('[data-dark-mode="system"]'),
                r = document.querySelector("[data-dark-mode-icon]");
            if (["on", "off", "system"].includes(e))
                "on" === e
                    ? (t._lHtml.classList.add("dark"),
                      (t._darkMode = "on"),
                      i && localStorage.setItem("dashmixDarkMode", "on"),
                      null == s || s.classList.remove("active"),
                      null == n || n.classList.add("active"),
                      null == o || o.classList.remove("active"),
                      r && (r.className = "fa fa-fw fa-moon"))
                    : "off" === e
                    ? (t._lHtml.classList.remove("dark"),
                      (t._darkMode = "off"),
                      i && localStorage.setItem("dashmixDarkMode", "off"),
                      null == s || s.classList.add("active"),
                      null == n || n.classList.remove("active"),
                      null == o || o.classList.remove("active"),
                      r && (r.className = "far fa-fw fa-moon"))
                    : "system" === e &&
                      (window.matchMedia("(prefers-color-scheme: dark)").matches
                          ...
                          : (t._lHtml.classList.remove("dark"),
                            r && (r.className = "far fa-fw fa-moon")),
                      (t._darkMode = "system"),
                      i && localStorage.setItem("dashmixDarkMode", "system"),
                      null == s || s.classList.remove("active"),
                      null == n || n.classList.remove("active"),
                ...
                i
                    ? (e =
                          localStorage.getItem("dashmixDarkMode") ||
                          t._darkMode)
                    : (localStorage.removeItem("dashmixDarkMode"),
                      (e = t._darkMode)),
                    "on" === e
                        ? t._uiHandleDarkMode("on")
                        : "off" === e
                        ? t._uiHandleDarkMode("off")
                        : "system" === e && t._uiHandleDarkMode("system"),
                    window
                        .matchMedia("(prefers-color-scheme: dark)")
                        .addEventListener("change", () => {
                            "system" === t._darkMode &&
                                t._uiHandleDarkMode("system");
                        });
            }
        }
        _uiHandleTheme() {
            let e = this,
                ...
                i = this._lHtml.classList.contains("remember-theme");
            if (i) {
                let i = localStorage.getItem("dashmixColorTheme") || !1;
                i && e._uiUpdateTheme(t, i),
                    (t = document.getElementById("css-theme"));
            } else localStorage.removeItem("dashmixColorTheme");
            document
                .querySelectorAll(
        ...
        _uiApiLayout() {
            let e =
                ...
                i = {
                    ...
                    header_glass_toggle: () => {
                        t._lPage.classList.toggle("page-header-glass"),
                            t._uiHandleHeader();
                    },
                    header_glass_on: () => {
                    ...
                    dark_mode_toggle: () => {
                        t._lHtml.classList.contains("dark")
                            ...
                            t &&
                                (e.classList.contains("block-mode-fullscreen")
                                    ? t &&
                                      t
                                          .querySelector("i")
                                          .classList.replace(o, r)
                                    : t &&
                                      t
                                          .querySelector("i")
                                          .classList.replace(r, o));
                    },
                    fullscreen_on: () => {
                        e.classList.remove("block-mode-pinned"),
        ...
        helpersOnLoad(e) {
            let t =
                arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : {};
            this.onLoad(() => pr.run(e, t));
        }
    }
    window.Dashmix = new (class extends fr {
        constructor(e) {
            super(e);
        }
    })({ darkMode: "system" });
