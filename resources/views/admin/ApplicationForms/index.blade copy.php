                                     ...
                                     {{-- @forelse ($forms as $key => $form)
                                      <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            <a href="{{ route('admin.application-forms.edit',$form->id) }}" class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="{{ route('admin.application-forms.destroy', $form->id) }}" class="btn btn-danger btn-sm deletebutton rounded-circle" style="width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
