...
@section('title', 'Caravan Optional Feature Forms')
...
<main class="main-wrapper">
    <div class="main-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Caravan Optional Features</div>
        <div class="ps-3">
      ...
      <div class="row g-3">
        ...
        <div class="col-auto align-items-end ">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a href="{{route('admin.master.optionalfeatures.create') }}" class="btn btn-primary px-4">
              <i class="bi bi-plus-lg me-2"></i>Add Caravan Optional Feature
            </a>
...
<script>
    $(function () {
        let table = $('#applicationFormTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.master.optionalfeatures.data') }}',
            order: [[0, 'desc']],
            columns: [
