...
<main class="main-wrapper">
    <div class="main-content">
        ...
        @can('edit ProvisionalZone')
        <div class="col-12 col-xl-12">
            <div class="card border-top border-3 border-danger rounded-0">
                <div class="card-body p-4">
                    <h5 class="mb-4">Edit Zone</h5>

                    <form class="row g-3"
                          method="POST"
                          action="{{ route('admin.master.zone.update', $zone->id) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            @php
                                ...
                                $selectedAreas = old('areas',
                                    is_string($zone->areas)
                                        ? json_decode($zone->areas, true)
                                        : ($zone->areas ?? [])
                                ) ?? [];
                            @endphp
                        ...
                        <div class="col-md-12">
                            <div class="d-md-flex d-grid align-items-center gap-3">
                                <button type="submit" class="btn btn-grd-primary px-4">Update</button>
                                    ...
                                    <a href="{{ route('admin.master.zone.edit', $zone->id) }}"
