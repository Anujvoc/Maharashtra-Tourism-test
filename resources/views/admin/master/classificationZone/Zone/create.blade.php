...
<main class="main-wrapper">
    <div class="main-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Zone</div>
        <div class="ps-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.master.zone.index') }}" class="btn btn-danger px-4">
  ...
  <div class="card border-top border-3 border-danger rounded-0">
    <div class="card-body p-4">
      <h5 class="mb-4">Add Zone</h5>
      @can('create ProvisionalZone')
      <form class="row g-3" method="POST" action="{{ route('admin.master.zone.store') }}" enctype="multipart/form-data">
        @csrf

        <!-- Zone Name -->
        <div class="col-md-6">
          <label for="input13" class="form-label">Zone</label>
          <div class="position-relative input-icon">
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
              id="input13" value="{{ old('name') }}" required placeholder="Enter Zone">
...
<!-- District Selection -->
                        ...
                        <div class="col-md-2 col-4 mb-2">
                            <div class="form-check">
                                <input
                                    ...
                                    value="{{ $area->id }}"
                                    id="area_{{ $area->id }}"
                                    @if(is_array(old('areas')) && in_array($area->id, old('area'))) checked @endif
                                >
        ...
        <div class="col-md-12">
          <div class="d-md-flex d-grid align-items-center gap-3">
            ...
            <a href="{{ route('admin.master.zone.create') }}" class="btn btn-grd-royal px-4">Reset</a>
          </div>
        </div>
      </form>
      @endcan
